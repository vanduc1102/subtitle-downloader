...
import OpenSubtitles from './os-api.js';
import CONST from './constants.js';
import { put } from './cache-file.js';
 ...
 */
export async function download(folders, languages = [ENG_LANG], user, pass) {
  console.log(
...
async function downloadFolder(folderPath, languages, user, pass) {
  ...
  const movieHashedList = await OpenSubtitles.getHashList(
    movieNeedSubtitleList,
  );
